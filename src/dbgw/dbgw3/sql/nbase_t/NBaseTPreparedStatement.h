...
#ifndef NBASETPREPAREDSTATEMENT_H_
#define NBASETPREPAREDSTATEMENT_H_
...
namespace dbgw
{
  ...
  namespace sql
  {
    ...
    class NBaseTPreparedStatement : public PreparedStatement
    {
    public:
      NBaseTPreparedStatement(trait<Connection>::sp pConnection,
          const char *szSql);
      virtual ~ NBaseTPreparedStatement();
