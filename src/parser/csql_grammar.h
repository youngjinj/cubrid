...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     DOLLAR_SIGN = 623,
     WON_SIGN = 624,
     TURKISH_LIRA_SIGN = 625,
     BRITISH_POUND_SIGN = 626,
     CAMBODIAN_RIEL_SIGN = 627,
     CHINESE_RENMINBI_SIGN = 628,
     INDIAN_RUPEE_SIGN = 629,
     RUSSIAN_RUBLE_SIGN = 630,
     AUSTRALIAN_DOLLAR_SIGN = 631,
     CANADIAN_DOLLAR_SIGN = 632,
     BRASILIAN_REAL_SIGN = 633,
     ROMANIAN_LEU_SIGN = 634,
     EURO_SIGN = 635,
     SWISS_FRANC_SIGN = 636,
     DANISH_KRONE_SIGN = 637,
     NORWEGIAN_KRONE_SIGN = 638,
     BULGARIAN_LEV_SIGN = 639,
     VIETNAMESE_DONG_SIGN = 640,
     CZECH_KORUNA_SIGN = 641,
     POLISH_ZLOTY_SIGN = 642,
     SWEDISH_KRONA_SIGN = 643,
     CROATIAN_KUNA_SIGN = 644,
     SERBIAN_DINAR_SIGN = 645,
     DOT = 646,
     RIGHT_ARROW = 647,
     STRCAT = 648,
     COMP_NOT_EQ = 649,
     ...
     WORKSPACE = 759,
     IdName = 760,
     BracketDelimitedIdName = 761,
     BacktickDelimitedIdName = 762,
     DelimitedIdName = 763,
     UNSIGNED_INTEGER = 764,
     UNSIGNED_REAL = 765,
     CHAR_STRING = 766,
     NCHAR_STRING = 767,
     BIT_STRING = 768,
...
#line 568 "../../src/parser/csql_grammar.y"
{
  int number;
  bool boolean;
  PT_NODE *node;
...
/* Line 2604 of glr.c.  */
#line 1115 "../../src/parser/csql_grammar.h"
	YYSTYPE;
