...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     DOLLAR_SIGN = 621,
     WON_SIGN = 622,
     TURKISH_LIRA_SIGN = 623,
     BRITISH_POUND_SIGN = 624,
     CAMBODIAN_RIEL_SIGN = 625,
     CHINESE_RENMINBI_SIGN = 626,
     INDIAN_RUPEE_SIGN = 627,
     RUSSIAN_RUBLE_SIGN = 628,
     AUSTRALIAN_DOLLAR_SIGN = 629,
     CANADIAN_DOLLAR_SIGN = 630,
     BRASILIAN_REAL_SIGN = 631,
     ROMANIAN_LEU_SIGN = 632,
     EURO_SIGN = 633,
     SWISS_FRANC_SIGN = 634,
     DANISH_KRONE_SIGN = 635,
     NORWEGIAN_KRONE_SIGN = 636,
     BULGARIAN_LEV_SIGN = 637,
     VIETNAMESE_DONG_SIGN = 638,
     CZECH_KORUNA_SIGN = 639,
     POLISH_ZLOTY_SIGN = 640,
     SWEDISH_KRONA_SIGN = 641,
     CROATIAN_KUNA_SIGN = 642,
     SERBIAN_DINAR_SIGN = 643,
     DOT = 644,
     RIGHT_ARROW = 645,
     STRCAT = 646,
     COMP_NOT_EQ = 647,
     ...
     WORKSPACE = 765,
     IdName = 766,
     BracketDelimitedIdName = 767,
     BacktickDelimitedIdName = 768,
     DelimitedIdName = 769,
     UNSIGNED_INTEGER = 770,
     UNSIGNED_REAL = 771,
     CHAR_STRING = 772,
     NCHAR_STRING = 773,
     BIT_STRING = 774,
...
/* Line 2604 of glr.c.  */
#line 1129 "../../src/parser/csql_grammar.h"
	YYSTYPE;
