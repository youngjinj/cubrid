...
typedef enum
{
  ...
  RVOVF_NEWPAGE_DELETE_RELOCATED = 120,

  RVBT_KEYVAL_INS_LFRECORD_MVCC_DELID = 121,

  RVBT_KEYVAL_DEL_RECORD_MVCC_DELID = 122,

  RVBT_KEYVAL_MVCC_INS = 123,
  RVBT_KEYVAL_MVCC_INS_LFRECORD_KEYINS = 124,
  RVBT_KEYVAL_MVCC_INS_LFRECORD_OIDINS = 125,

  RVVAC_REMOVE_HEAP_OIDS = 126,
  RVVAC_LOG_BLOCK_REMOVE = 127,
  RVVAC_LOG_BLOCK_APPEND = 128,
  RVVAC_LOG_BLOCK_MODIFY = 129,
  RVVAC_DROPPED_CLS_BTID_ADD = 130,
  RVVAC_DROPPED_CLS_BTID_CLEANUP = 131,
  RVVAC_DROPPED_CLS_BTID_NEXT_PAGE = 132,

  RVBT_MVCC_INCREMENTS_UPD = 133,
