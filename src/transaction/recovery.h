...
typedef enum
{
  ...
  RVHF_MVCC_VACUUM_HEAP_PAGE = 118,
  RVHF_MVCC_VACUUM_REMOVE_OIDS = 119,

  RVBT_KEYVAL_INS_LFRECORD_MVCC_DELID = 120,

  RVBT_KEYVAL_DEL_RECORD_MVCC_DELID = 121,

  RVHF_MVCC_DELETE_RELOCATED = 122,
