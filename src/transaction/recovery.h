...
typedef enum
{
  ...
  RVHF_MVCC_INSERT = 114,
  RVHF_MVCC_DELETE = 115,
  RVHF_MVCC_UPDATE = 116,

  RVHF_MVCC_VACUUM_HEAP_PAGE = 117,
  RVHF_MVCC_VACUUM_REMOVE_OIDS = 118,

  RVHF_MVCC_UPDATE_ROW_VERSION = 119,
