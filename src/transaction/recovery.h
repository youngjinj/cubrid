...
typedef enum
{
  ...
  RVVAC_LOG_BLOCK_REMOVE = 128,
  RVVAC_LOG_BLOCK_APPEND = 129,
  RVVAC_LOG_BLOCK_MODIFY = 130,
  RVVAC_DROPPED_CLS_BTID_ADD = 131,
  RVVAC_DROPPED_CLS_BTID_CLEANUP = 132,
  RVVAC_DROPPED_CLS_BTID_NEXT_PAGE = 133,

  RVBT_MVCC_INCREMENTS_UPD = 134,
