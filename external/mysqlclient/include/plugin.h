...
typedef int (*mysql_show_var_func) (MYSQL_THD, struct st_mysql_show_var *,
				    char *);
...
extern "C"
{
  ...
  char *thd_security_context (MYSQL_THD thd, char *buffer,
			      unsigned int length,
...
*/
  void mysql_query_cache_invalidate4 (MYSQL_THD thd,
				      const char *key,
				      unsigned int key_length, int using_trx);
