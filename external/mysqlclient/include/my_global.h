...
C_MODE_START double my_ulonglong2double (unsigned long long A);
C_MODE_END
#endif /* _AIX */
...
C_MODE_START int __cxa_pure_virtual () __attribute__ ((weak));
C_MODE_END
#endif
/* From old s-system.h */
/*
...
C_MODE_START typedef void (*sig_return) ();	/* Returns type from signal */
C_MODE_END
