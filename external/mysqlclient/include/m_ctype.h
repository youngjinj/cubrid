...
/* See strings/CHARSET_INFO.txt for information about this structure  */
  typedef struct my_collation_handler_st
  {
    ...
    /* Hash calculation */
    void (*hash_sort) (struct charset_info_st * cs, const uchar * key,
		       size_t len, ulong * nr1, ulong * nr2);
      my_bool (*propagate) (struct charset_info_st * cs, const uchar * str,
			    size_t len);
...
/* See strings/CHARSET_INFO.txt about information on this structure  */
  typedef struct my_charset_handler_st
  {
    ...
    size_t (*numchars) (struct charset_info_st *, const char *b,
			const char *e);
    size_t (*charpos) (struct charset_info_st *, const char *b, const char *e,
		       size_t pos);
    size_t (*well_formed_len) (struct charset_info_st *, const char *b,
			       const char *e, size_t nchars, int *error);
    size_t (*lengthsp) (struct charset_info_st *, const char *ptr,
			size_t length);
    size_t (*numcells) (struct charset_info_st *, const char *b,
			const char *e);
    ...
    /* Charset dependant snprintf() */
      ...
      size_t (*longlong10_to_str) (struct charset_info_st *, char *to,
    ...
    long (*strntol) (struct charset_info_st *, const char *s, size_t l,
      ...
      longlong (*strntoll) (struct charset_info_st *, const char *s, size_t l,
			    int base, char **e, int *err);
      ulonglong (*strntoull) (struct charset_info_st *, const char *s,
			      size_t l, int base, char **e, int *err);
    double (*strntod) (struct charset_info_st *, char *s, size_t l, char **e,
		       int *err);
      longlong (*strtoll10) (struct charset_info_st * cs, const char *nptr,
...
/* declarations for simple charsets */
  ...
  extern size_t my_lengthsp_8bit (CHARSET_INFO * cs, const char *ptr,
				  size_t length);
...
/* Functions for 8bit */
  ...
  extern int my_strcasecmp_8bit (CHARSET_INFO * cs, const char *,
				 const char *);

  int my_mb_wc_8bit (CHARSET_INFO * cs, my_wc_t * wc, const uchar * s,
		     const uchar * e);
  ...
  size_t my_scan_8bit (CHARSET_INFO * cs, const char *b, const char *e,
		       int sq);
  ...
  ulong my_strntoul_8bit (CHARSET_INFO *, const char *s, size_t l, int base,
			  char **e, int *err);
  longlong my_strntoll_8bit (CHARSET_INFO *, const char *s, size_t l,
			     int base, char **e, int *err);
  ulonglong my_strntoull_8bit (CHARSET_INFO *, const char *s, size_t l,
			       int base, char **e, int *err);
  ...
  size_t my_long10_to_str_8bit (CHARSET_INFO *, char *to, size_t l, int radix,
				long int val);
  size_t my_longlong10_to_str_8bit (CHARSET_INFO *, char *to, size_t l,
  ...
  size_t my_charpos_8bit (CHARSET_INFO *, const char *b, const char *e,
			  size_t pos);
  size_t my_well_formed_len_8bit (CHARSET_INFO *, const char *b,
...
/* Functions for multibyte charsets */
  ...
  size_t my_charpos_mb (CHARSET_INFO *, const char *b, const char *e,
			size_t pos);
  size_t my_well_formed_len_mb (CHARSET_INFO *, const char *b, const char *e,
				size_t pos, int *error);
  uint my_instr_mb (struct charset_info_st *, const char *b, size_t b_length,
  ...
  my_bool my_propagate_simple (CHARSET_INFO * cs, const uchar * str,
			       size_t len);
  my_bool my_propagate_complex (CHARSET_INFO * cs, const uchar * str,
				size_t len);
