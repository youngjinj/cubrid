...
Purpose
To set the options for the given LOCAL Lob.
...
Comments
This function only works on LOCAL Lobs.  All others will get an error.
...
typedef sb4 (*OCICallbackFailover) (void *svcctx, void *envctx,
				    void *fo_ctx, ub4 fo_type, ub4 fo_event);
...
sword OCIEnvNlsCreate (OCIEnv ** envp, ub4 mode, void *ctxp,
		       ...
		       void *(*ralocfp) (void *ctxp, void *memptr,
					 size_t newsize),
		       void (*mfreefp) (void *ctxp, void *memptr),
		       size_t xtramem_sz, void **usrmempp, ub2 charset,
		       ub2 ncharset);
...
sword OCIStmtPrepare2 (OCISvcCtx * svchp, OCIStmt ** stmtp, OCIError * errhp,
		       ...
		       const OraText * key, ub4 key_len, ub4 language,
		       ub4 mode);
...
sword OCILobAppend (OCISvcCtx * svchp, OCIError * errhp,
		    OCILobLocator * dst_locp, OCILobLocator * src_locp);
...
sword OCILobCopy (OCISvcCtx * svchp, OCIError * errhp,
		  OCILobLocator * dst_locp, OCILobLocator * src_locp,
...
sword OCILobFlushBuffer (OCISvcCtx * svchp,
			 OCIError * errhp, OCILobLocator * locp, ub4 flag);
...
sword OCILobGetChunkSize (OCISvcCtx * svchp,
			  OCIError * errhp,
			  OCILobLocator * locp, ub4 * chunksizep);
...
sword OCILobIsOpen (OCISvcCtx * svchp,
		    OCIError * errhp, OCILobLocator * locp, boolean * flag);

sword OCILobIsTemporary (OCIEnv * envp,
			 OCIError * errhp,
			 OCILobLocator * locp, boolean * is_temporary);
...
sword OCILobOpen (OCISvcCtx * svchp,
		  OCIError * errhp, OCILobLocator * locp, ub1 mode);
...
sword OCILobCopy2 (OCISvcCtx * svchp, OCIError * errhp,
		   ...
		   oraub8 dst_offset, oraub8 src_offset);
...
sword OCISecurityOpenWallet (OCISecurity * osshandle,
			     ...
			     size_t pwdlen,
			     OraText * password, nzttWallet * wallet);

sword OCISecurityCloseWallet (OCISecurity * osshandle,
			      OCIError * error_handle, nzttWallet * wallet);
...
sword OCISecurityDestroyWallet (OCISecurity * osshandle,
				...
				size_t wrllen,
				OraText * wallet_resource_locator,
				size_t pwdlen, OraText * password);

sword OCISecurityStorePersona (OCISecurity * osshandle,
			       OCIError * error_handle,
			       nzttPersona ** persona, nzttWallet * wallet);

sword OCISecurityOpenPersona (OCISecurity * osshandle,
			      OCIError * error_handle, nzttPersona * persona);
...
sword OCISecuritySign (OCISecurity * osshandle,
		       ...
		       size_t input_length,
		       ub1 * input, nzttBufferBlock * buffer_block);

sword OCISecuritySignExpansion (OCISecurity * osshandle,
				OCIError * error_handle,
				nzttPersona * persona,
				size_t inputlen, size_t * signature_length);
...
sword OCISecurityValidate (OCISecurity * osshandle,
			   OCIError * error_handle,
			   nzttPersona * persona,
			   nzttIdentity * identity, boolean * validated);
...
sword OCISecuritySignDetached (OCISecurity * osshandle,
			       ...
			       nzttces signature_state,
			       size_t input_length,
			       ub1 * input, nzttBufferBlock * signature);
...
sword OCISecurity_PKEncrypt (OCISecurity * osshandle,
			     ...
			     size_t input_length,
			     ub1 * input, nzttBufferBlock * encrypted_data);
...
sword OCISecurityDecrypt (OCISecurity * osshandle,
			  ...
			  size_t input_length,
			  ub1 * input, nzttBufferBlock * decrypted_data);
...
sword OCISecurityEnvelope (OCISecurity * osshandle,
			   ...
			   nzttces encryption_state,
			   size_t input_length,
			   ub1 * input, nzttBufferBlock * enveloped_data);
...
sword OCISecurityKeyedHash (OCISecurity * osshandle,
			    ...
			    nzttces hash_state,
			    size_t input_length,
			    ub1 * input, nzttBufferBlock * keyed_hash);
...
sword OCISecurityHash (OCISecurity * osshandle,
		       ...
		       nzttces hash_state,
		       size_t input,
		       ub1 * input_length, nzttBufferBlock * hash);
...
sword OCISecuritySetBlock (OCISecurity * osshandle,
			   ...
			   ub1 * buffer, nzttBufferBlock * buffer_block);
...
sword OCIAQEnqArray (OCISvcCtx * svchp, OCIError * errhp,
		     OraText * queue_name, OCIAQEnqOptions * enqopt,
		     ub4 * iters, OCIAQMsgProperties ** msgprop,
		     OCIType * payload_tdo, void **payload,
		     void **payload_ind, OCIRaw ** msgid, void *ctxp,
		     OCICallbackAQEnq enqcbfp, ub4 flags);

sword OCIAQEnqStreaming (OCISvcCtx * svchp, OCIError * errhp,
			 OraText * queue_name, OCIAQEnqOptions * enqopt,
			 OCIType * payload_tdo, void *ctxp,
			 OCICallbackAQEnqStreaming enqcbfp, ub4 flags);

sword OCIAQDeqArray (OCISvcCtx * svchp, OCIError * errhp,
		     OraText * queue_name, OCIAQDeqOptions * deqopt,
		     ub4 * iters, OCIAQMsgProperties ** msgprop,
		     OCIType * payload_tdo, void **payload,
		     void **payload_ind, OCIRaw ** msgid, void *ctxp,
		     OCICallbackAQDeq deqcbfp, ub4 flags);

sword OCIAQListen (OCISvcCtx * svchp, OCIError * errhp,
		   OCIAQAgent ** agent_list, ub4 num_agents,
		   sb4 wait, OCIAQAgent ** agent, ub4 flags);
...
sword OCIExtractFromStr (void *hndl, OCIError * err, ub4 flag,
			 OraText * input);
...
sword OCIContextClearValue (void *hdl, OCIError * err, ub1 * key, ub1 keylen);
...
sword OCIPicklerTdsCtxFree (OCIEnv * env, OCIError * err,
			    OCIPicklerTdsCtx * tdsc);

sword OCIPicklerTdsInit (OCIEnv * env, OCIError * err,
			 OCIPicklerTdsCtx * tdsc, OCIPicklerTds ** tdsh);
...
sword OCIPicklerImageInit (OCIEnv * env, OCIError * err,
			   OCIPicklerFdo * fdoh,
			   OCIPicklerTds * tdsh, OCIPicklerImage ** imgh);
...
sword OCIAnyDataGetType (OCISvcCtx * svchp, OCIError * errhp,
			 OCIAnyData * sdata, OCITypeCode * tc,
			 OCIType ** type);

sword OCIAnyDataIsNull (OCISvcCtx * svchp, OCIError * errhp,
			OCIAnyData * sdata, boolean * isnull);

sword OCIAnyDataConvert (OCISvcCtx * svchp, OCIError * errhp, OCITypeCode tc,
			 OCIType * type, OCIDuration dur, void *ind,
			 void *data_val, ub4 len, OCIAnyData ** sdata);

sword OCIAnyDataBeginCreate (OCISvcCtx * svchp, OCIError * errhp,
			     OCITypeCode tc, OCIType * type, OCIDuration dur,
			     OCIAnyData ** sdata);

sword OCIAnyDataDestroy (OCISvcCtx * svchp, OCIError * errhp,
			 OCIAnyData * sdata);

sword OCIAnyDataAttrSet (OCISvcCtx * svchp, OCIError * errhp,
			 OCIAnyData * sdata, OCITypeCode tc, OCIType * type,
			 void *ind, void *attr_val, ub4 length,
			 boolean is_any);

sword OCIAnyDataCollAddElem (OCISvcCtx * svchp, OCIError * errhp,
			     OCIAnyData * sdata, OCITypeCode tc,
			     OCIType * type, void *ind, void *attr_val,
			     ub4 length, boolean is_any, boolean last_elem);

sword OCIAnyDataEndCreate (OCISvcCtx * svchp, OCIError * errhp,
			   OCIAnyData * sdata);

sword OCIAnyDataAccess (OCISvcCtx * svchp, OCIError * errhp,
			OCIAnyData * sdata, OCITypeCode tc, OCIType * type,
			void *ind, void *attr_val, ub4 * length);
...
sword OCIAnyDataAttrGet (OCISvcCtx * svchp, OCIError * errhp,
			 OCIAnyData * sdata, OCITypeCode tc, OCIType * type,
			 void *ind, void *attr_val, ub4 * length,
			 boolean is_any);
...
sword OCIAnyDataCollGetElem (OCISvcCtx * svchp, OCIError * errhp,
			     OCIAnyData * sdata,
			     OCITypeCode tc, OCIType * type, void *ind,
			     void *celem_val, ub4 * length, boolean is_any);
...
sword OCIAnyDataSetBeginCreate (OCISvcCtx * svchp, OCIError * errhp,
				OCITypeCode typecode, const OCIType * type,
				OCIDuration dur, OCIAnyDataSet ** data_set);
...
sword OCIAnyDataSetGetType (OCISvcCtx * svchp, OCIError * errhp,
			    OCIAnyDataSet * data_set, OCITypeCode * tc,
			    OCIType ** type);
...
*/
sword OCINlsNumericInfoGet (void *envhp, OCIError * errhp, sb4 * val,
			    ub2 item);
...
*/
sword OCINlsCharSetIdToName (void *envhp, oratext * buf, size_t buflen,
			     ub2 id);
...
*/
sword OCIMultiByteToWideChar (void *envhp, OCIWchar * dst,
			      const OraText * src, size_t * rsize);
...
/*
   ...
   rsize (OUT)
     ...
     If it is NULL pointer, nothing to return.
*/
sword OCIWideCharToMultiByte (void *envhp, OraText * dst,
			      const OCIWchar * src, size_t * rsize);
...
/*
   ...
   wc(IN)
     Wchar to search for.
*/
OCIWchar *OCIWideCharStrchr (void *envhp, const OCIWchar * wstr, OCIWchar wc);
...
sword OCICharSetToUnicode (void *envhp, ub2 * dst, size_t dstlen,
			   const OraText * src, size_t srclen,
			   size_t * rsize);
...
sword OCIDateTimeGetDate (void *hndl, OCIError * err,
			  const OCIDateTime * date, sb2 * yr, ub1 * mnth,
			  ub1 * dy);
...
sword OCIDateTimeConstruct (void *hndl, OCIError * err,
			    OCIDateTime * datetime, sb2 yr, ub1 mnth, ub1 dy,
			    ub1 hr, ub1 mm, ub1 ss, ub4 fsec,
			    OraText * timezone, size_t timezone_length);
...
sword OCIDateTimeFromText (void *hndl, OCIError * err,
			   const OraText * date_str, size_t dstr_length,
			   const OraText * fmt, ub1 fmt_length,
			   const OraText * lang_name, size_t lang_length,
			   OCIDateTime * date);

sword OCIDateTimeCompare (void *hndl, OCIError * err,
...
sword OCIDateTimeIntervalAdd (void *hndl, OCIError * err,
			      OCIDateTime * datetime, OCIInterval * inter,
			      OCIDateTime * outdatetime);

sword OCIDateTimeIntervalSub (void *hndl, OCIError * err,
			      OCIDateTime * datetime, OCIInterval * inter,
			      OCIDateTime * outdatetime);
...
sword OCIIntervalMultiply (void *hndl, OCIError * err,
			   const OCIInterval * inter, OCINumber * nfactor,
			   OCIInterval * result);
...
sword OCIIntervalToText (void *hndl, OCIError * err,
			 const OCIInterval * inter, ub1 lfprec, ub1 fsprec,
			 OraText * buffer, size_t buflen, size_t * resultlen);

sword OCIIntervalToNumber (void *hndl, OCIError * err,
			   const OCIInterval * inter, OCINumber * number);

sword OCIIntervalCheck (void *hndl, OCIError * err,
...
sword OCIIntervalGetYearMonth (void *hndl, OCIError * err, sb4 * yr,
			       sb4 * mnth, const OCIInterval * result);

sword OCIIntervalSetDaySecond (void *hndl, OCIError * err, sb4 dy, sb4 hr,
			       sb4 mm, sb4 ss, sb4 fsec,
			       OCIInterval * result);
...
sword OCIDateTimeToArray (void *hndl, OCIError * err,
			  const OCIDateTime * datetime,
			  const OCIInterval * reftz, ub1 * outarray,
			  ub4 * len, ub1 fsprec);

sword OCIDateTimeFromArray (void *hndl, OCIError * err, ub1 * inarray,
...
sword OCIIntervalFromTZ (void *hndl, OCIError * err,
...
sword OCIConnectionPoolCreate (OCIEnv * envhp, OCIError * errhp,
			       OCICPool * poolhp, OraText ** poolName,
			       sb4 * poolNameLen, const OraText * dblink,
			       sb4 dblinkLen, ub4 connMin, ub4 connMax,
			       ub4 connIncr, const OraText * poolUserName,
			       sb4 poolUserLen, const OraText * poolPassword,
			       sb4 poolPassLen, ub4 mode);
...
sword OCISessionPoolCreate (OCIEnv * envhp, OCIError * errhp,
			    OCISPool * spoolhp, OraText ** poolName,
			    ub4 * poolNameLen, const OraText * connStr,
			    ub4 connStrLen, ub4 sessMin, ub4 sessMax,
			    ub4 sessIncr, OraText * userid, ub4 useridLen,
...
sword OCIKerbAttrSet (OCISession * trgthndlp, ub4 cred_use, ub1 * ftgt_ticket,
		      ...
		      oratext * ftgt_client_realm, ub4 ftgt_client_realm_len,
		      OCIError * errhp);
...
sword OCIDBStartup (OCISvcCtx * svchp,
		    OCIError * errhp, OCIAdmin * admhp, ub4 mode, ub4 flags);

sword OCIDBShutdown (OCISvcCtx * svchp,
		     OCIError * errhp, OCIAdmin * admhp, ub4 mode);
...
void OCIClientVersion (sword * major_version,
		       sword * minor_version,
		       sword * update_num,
		       sword * patch_num, sword * port_update_num);
/*----------------------- End OCIClientVersion --------------------------*/

/*----------------------- HA Event prototypes ------------------------------*/

sword OCIInitEventHandle (OCIError * errhp,
			  OCIEvent * event, text * str, ub4 size);
...
sword OCIStmtBindByName (OCIStmt * stmtp, OCIBind * bindp, OCIError * errhp,
			 ...
			 ub2 * alenp, ub2 * rcodep, ub4 maxarr_len,
