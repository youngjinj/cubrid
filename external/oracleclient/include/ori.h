...
sword OCIObjectNew (OCIEnv * env, OCIError * err, const OCISvcCtx * svc,
		    ...
		    OCIDuration duration, boolean value, void **instance);
/*
...
/*------------------------- OCIObjectExists --------------------------------*/
sword OCIObjectExists (OCIEnv * env, OCIError * err, void *ins,
		       boolean * exist);
/*
...
sword OCIObjectPinTable (OCIEnv * env, OCIError * err, const OCISvcCtx * svc,
			 ...
			 ub4 s_n_length, const oratext * object_name,
			 ub4 o_n_length, const OCIRef * scope_obj_ref,
			 OCIDuration pin_duration, void **object);
/*
...
sword OCICacheFlush (OCIEnv * env, OCIError * err, const OCISvcCtx * svc,
		     void *context, OCIRef * (*get) (void *context,
						     ub1 * last),
		     OCIRef ** ref);
/*
...
sword OCICacheGetObjects (OCIEnv * env, OCIError * err,
			  ...
			  void *client_context,
			  void (*client_callback) (void *client_context,
						   void *object));
