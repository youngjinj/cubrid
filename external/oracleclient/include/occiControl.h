...
/*---------------------------------------------------------------------------
  ...
  ---------------------------------------------------------------------------*/
	...
	ATTR_IS_SYSTEM_GENERATED_TYPE = OCI_ATTR_IS_SYSTEM_GENERATED_TYPE,
	...
	ATTR_CURSOR_COMMIT_BEHAVIOR = OCI_ATTR_CURSOR_COMMIT_BEHAVIOR,
	...
	ATTR_TABLE_ENC_ALG_ID = OCI_ATTR_TABLE_ENC_ALG_ID
      ...
      enum ParamType
      {
	PTYPE_TABLE = OCI_PTYPE_TABLE, PTYPE_VIEW =
	  OCI_PTYPE_VIEW, PTYPE_PROC = OCI_PTYPE_PROC, PTYPE_FUNC =
	  OCI_PTYPE_FUNC, PTYPE_PKG = OCI_PTYPE_PKG, PTYPE_TYPE =
	  OCI_PTYPE_TYPE, PTYPE_TYPE_ATTR =
	  OCI_PTYPE_TYPE_ATTR, PTYPE_TYPE_COLL =
	  OCI_PTYPE_TYPE_COLL, PTYPE_TYPE_METHOD =
	  OCI_PTYPE_TYPE_METHOD, PTYPE_SYN = OCI_PTYPE_SYN, PTYPE_SEQ =
	  OCI_PTYPE_SEQ, PTYPE_COL = OCI_PTYPE_COL, PTYPE_ARG =
	  OCI_PTYPE_ARG, PTYPE_TYPE_ARG =
	  OCI_PTYPE_TYPE_ARG, PTYPE_TYPE_RESULT =
	  OCI_PTYPE_TYPE_RESULT, PTYPE_SCHEMA =
	  OCI_PTYPE_SCHEMA, PTYPE_DATABASE = OCI_PTYPE_DATABASE, PTYPE_UNK =
	  OCI_PTYPE_UNK
      };


      enum
      { DURATION_SESSION = OCI_DURATION_SESSION, DURATION_TRANS =
	  OCI_DURATION_TRANS, DURATION_NULL =
	  OCI_DURATION_NULL, TYPEENCAP_PRIVATE =
	  OCI_TYPEENCAP_PRIVATE, TYPEENCAP_PUBLIC =
	  OCI_TYPEENCAP_PUBLIC, TYPEPARAM_IN =
	  OCI_TYPEPARAM_IN, TYPEPARAM_OUT =
	  OCI_TYPEPARAM_OUT, TYPEPARAM_INOUT =
	  OCI_TYPEPARAM_INOUT, CURSOR_OPEN = OCI_CURSOR_OPEN, CURSOR_CLOSED =
	  OCI_CURSOR_CLOSED, CL_START = OCI_CL_START, CL_END =
	  OCI_CL_END, SP_SUPPORTED = OCI_SP_SUPPORTED, SP_UNSUPPORTED =
	  OCI_SP_UNSUPPORTED, NW_SUPPORTED =
	  OCI_NW_SUPPORTED, NW_UNSUPPORTED = OCI_NW_UNSUPPORTED, AC_DDL =
	  OCI_AC_DDL, NO_AC_DDL = OCI_NO_AC_DDL, LOCK_IMMEDIATE =
	  OCI_LOCK_IMMEDIATE, LOCK_DELAYED = OCI_LOCK_DELAYED
      };
      ...
      MetaData getMetaData (MetaData::AttrId attrid) const;
        OCCI_STD_NAMESPACE::vector < MetaData >
	getVector (MetaData::AttrId attrid) const;
	...
	UNK_ATTR_COUNT = 0
      ...
      static const ociAttrType
	argtargtresAttrType[ARG_TYPARG_TYPRES_ATTR_COUNT];
      ...
      AttrCount attrCount;
        ...
        MetaData (const Connection * sessp,
		  const OCCI_STD_NAMESPACE::string & objName,
		  ParamType prmtyp);
        MetaData (const Connection * sessp, const UString & objName,
		  ParamType prmtyp);
        MetaData (const Connection * sessp, const RefAny & ref);
...
//return codes for user callbacks
	...
	SELF = OCI_ATTR_PURITY_SELF
      ...
      virtual Statement *createStatement (const OCCI_STD_NAMESPACE::
					  string & sql = "") = 0;
      ...
      virtual MetaData getMetaData (const OCCI_STD_NAMESPACE::string & object,
				    ...
				    = MetaData::PTYPE_UNK) const = 0;
      virtual MetaData getMetaData (const RefAny & ref) const = 0;
      virtual OCCI_STD_NAMESPACE::string getClientCharSet () const = 0;
      virtual OCCI_STD_NAMESPACE::string getClientNCHARCharSet () const = 0;
      ...
      virtual MetaData getMetaData (const UString & object,
				    MetaData::ParamType prmtyp
				    = MetaData::PTYPE_UNK) const = 0;
      virtual UString getClientCharSetUString () const = 0;
      virtual UString getClientNCHARCharSetUString () const = 0;
      ...
      virtual void registerSubscriptions (const OCCI_STD_NAMESPACE::vector <
					  aq::Subscription > &sub) = 0;
      virtual void unregisterSubscription (const aq::Subscription & sub) = 0;
      virtual void postToSubscriptions (const OCCI_STD_NAMESPACE::vector <
					aq::Subscription > &sub) = 0;
      virtual Statement *createStatement (const UString & sql,
					  const UString & tag) = 0;
      virtual void terminateStatement (Statement * stmt,
				       const UString & tag) = 0;
      virtual bool isCached (const UString & sql, const UString & tag) = 0;
      virtual void
	setTAFNotify (int (*notifyFn)
		      (Environment * env, Connection * conn, void *ctx,
	...
	SPD_FORCE = OCI_SPD_FORCE
      ...
      virtual void setPoolSize (unsigned int maxConn = 1,
				...
				0, unsigned int incrConn = 1) = 0;
      virtual Connection *getConnection (const OCCI_STD_NAMESPACE::
					 string & tag = "") = 0;
      virtual Connection *getConnection (const OCCI_STD_NAMESPACE::
					 string & userName,
					 const OCCI_STD_NAMESPACE::
					 ...
					 const OCCI_STD_NAMESPACE::
					 string & tag = "") = 0;
      virtual Connection *getAnyTaggedConnection (const OCCI_STD_NAMESPACE::
						  string & tag = "") = 0;
      virtual Connection *getAnyTaggedConnection (const OCCI_STD_NAMESPACE::
						  string & userName,
						  const OCCI_STD_NAMESPACE::
						  ...
						  const OCCI_STD_NAMESPACE::
						  string & tag = "") = 0;
      virtual Connection *getProxyConnection (const OCCI_STD_NAMESPACE::
					      string & name,
					      OCCI_STD_NAMESPACE::
					      string roles[],
      ...
      virtual Connection *getProxyConnection (const OCCI_STD_NAMESPACE::
					      ...
					      ProxyType proxyType =
					      Connection::PROXY_DEFAULT) = 0;
      virtual Connection *getAnyTaggedProxyConnection (const
						       OCCI_STD_NAMESPACE::
						       string & name,
						       OCCI_STD_NAMESPACE::
						       string roles[],
      ...
      virtual Connection *getConnection (const UString & connectionClass,
					 const Connection::Purity purity,
					 const UString & tag) = 0;
      ...
      virtual Connection *getAnyTaggedConnection (const UString &
						  connectionClass,
						  const Connection::
						  Purity purity,
						  const UString & tag) = 0;
    ...
    public:virtual ~ ConnectionPool ()
      ...
      virtual OCCI_STD_NAMESPACE::string getPoolName () const = 0;
      virtual unsigned int getTimeOut () const = 0;
      virtual void setErrorOnBusy () = 0;
      virtual void setTimeOut (unsigned int connTimeOut = 0) = 0;
      virtual void setPoolSize (unsigned int minConn = 0,
				unsigned int maxConn =
				1, unsigned int incrConn = 1) = 0;
      virtual Connection *createConnection (const OCCI_STD_NAMESPACE::
					    string & userName,
					    const OCCI_STD_NAMESPACE::
					    string & password) = 0;

      virtual Connection *createProxyConnection (const OCCI_STD_NAMESPACE::
						 string & name,
						 OCCI_STD_NAMESPACE::
						 string roles[],
						 unsigned int numRoles,
	...
	0;
      ...
      virtual UString getPoolNameUString () const = 0;
    };
	...
	USE_LDAP = OCI_USE_LDAP
      ...
      static Environment *createEnvironment (Mode mode = DEFAULT,
					     ...
					     void *(*malocfp) (void *ctxp,
							       size_t size) =
					     0, void *(*ralocfp) (void *ctxp,
								  void
								  *memptr,
								  size_t
								  newsize) =
					     0, void (*mfreefp) (void *ctxp,
								 void *memptr)
					     = 0);

      static Environment *createEnvironment (const OCCI_STD_NAMESPACE::
					     string & charset,
					     const OCCI_STD_NAMESPACE::
					     string & ncharset, Mode mode =
					     DEFAULT, void *ctxp =
					     0, void *(*malocfp) (void *ctxp,
								  size_t size)
					     =
					     0, void *(*ralocfp) (void *ctxp,
								  void
      ...
      virtual Connection *createConnection (const OCCI_STD_NAMESPACE::
					    ...
					    string & password,
					    const OCCI_STD_NAMESPACE::
					    string & connectString = "") = 0;

      virtual void terminateConnection (Connection * connection) = 0;

      virtual ConnectionPool *createConnectionPool (const OCCI_STD_NAMESPACE::
						    string & poolUserName,
						    const OCCI_STD_NAMESPACE::
						    string & poolPassword,
						    const OCCI_STD_NAMESPACE::
						    ...
						    "", unsigned int minConn =
						    0, unsigned int maxConn =
						    1, unsigned int incrConn =
						    1) = 0;
	...
	0;
      ...
      virtual ConnectionPool *createConnectionPool (const UString &
						    poolUserName,
						    const UString &
						    poolPassword,
						    const UString &
      ...
      virtual StatelessConnectionPool *createStatelessConnectionPool (const
								      OCCI_STD_NAMESPACE::
								      string &
								      poolUserName,
								      const
	...
	= 0;
      ...
      virtual void terminateStatelessConnectionPool (StatelessConnectionPool *
						     poolp,
						     StatelessConnectionPool::
						     DestroyMode mode =
						     StatelessConnectionPool::
      ...
      virtual void setLDAPLoginNameAndPassword (const OCCI_STD_NAMESPACE::
						string & login,
						const OCCI_STD_NAMESPACE::
						string & passwd) = 0;

      virtual void setLDAPAdminContext (const OCCI_STD_NAMESPACE::
					string & ctx) = 0;

      virtual OCCI_STD_NAMESPACE::string getLDAPAdminContext () const = 0;

      virtual void setLDAPHostAndPort (const OCCI_STD_NAMESPACE::
				       string & host, unsigned int port) = 0;
    ...
    public:
      ...
      virtual void put (const OCCI_STD_NAMESPACE::string &, void *(*)(void *),
			void (*)(void *, void *)) = 0;
      virtual void getReadSQL (void *, unsigned int, void *, unsigned int,
			       void **) const = 0;
      virtual void getWriteSQL (void *, unsigned int, void *, unsigned int,
				void **) const = 0;
      ...
      virtual void putUTF16 (const OCCI_STD_NAMESPACE::string &,
			     const OCCI_STD_NAMESPACE::string &,
			     void *(*)(void *), void (*)(void *, void *)) = 0;
    ...
    public:
      ...
      virtual int getXAErrorCode (const OCCI_STD_NAMESPACE::
				  string & dbname) const;

      virtual UString getUStringMessage () const;

      virtual OCCI_STD_NAMESPACE::string getNLSMessage (Environment *
							env) const;
    ...
    protected:
      ...
      friend SQLException SQLExceptionCreate (void *handle, int handleType);
	...
	STREAM_DATA_AVAILABLE
      ...
      virtual Status execute (const OCCI_STD_NAMESPACE::string & sql = "") =
	0;
      ...
      virtual ResultSet *executeQuery (const OCCI_STD_NAMESPACE::
				       string & sql = "") = 0;

      virtual unsigned int executeUpdate (const OCCI_STD_NAMESPACE::
					  string & sql = "") = 0;
      ...
      virtual void setMaxParamSize (unsigned int paramIndex,
				    unsigned int maxSize) = 0;

      virtual unsigned int getMaxParamSize (unsigned int paramIndex) const =
	0;
      ...
      virtual void setTimestamp (unsigned int paramIndex,
				 const Timestamp & x) = 0;
      ...
      virtual void setIntervalYM (unsigned int paramIndex,
				  const IntervalYM & x) = 0;

      virtual void setIntervalDS (unsigned int paramIndex,
				  const IntervalDS & x) = 0;
	...
	const = 0;
      ...
      virtual OCCI_STD_NAMESPACE::string getString (unsigned int paramIndex) =
	0;
	...
	0;
      ...
      virtual ResultSet *executeQuery (const UString & sql) = 0;

      virtual unsigned int executeUpdate (const UString & sql) = 0;

      virtual void setBFloat (unsigned int paramIndex, const BFloat & fval) =
	0;

      virtual void setBDouble (unsigned int paramIndex,
      ...
      virtual UString getCharSetUString (unsigned int paramIndex) const = 0;
	...
	STREAM_DATA_AVAILABLE
      ...
      virtual void setMaxColumnSize (unsigned int colIndex,
				     unsigned int max) = 0;
      ...
      virtual void setErrorOnNull (unsigned int colIndex,
				   bool causeException) = 0;
      virtual void setErrorOnTruncate (unsigned int paramIndex,
				       bool causeException) = 0;
      ...
      virtual OCCI_STD_NAMESPACE::string getString (unsigned int colIndex) =
	0;
      ...
      virtual void setDataBuffer (unsigned int colIndex, void *buffer,
				  Type type, sb4 size = 0, ub2 * length =
	...
	const = 0;
      ...
      virtual OCCI_STD_NAMESPACE::vector < MetaData >
	getColumnListMetaData () const = 0;
    ...
    {
    public:enum Status
      { READY_FOR_READ, READY_FOR_WRITE, INACTIVE };
...
/*---------------------------------------------------------------------------
 ...
 -------------------------------------------------------------------------*/
    ...
    void setVectorOfPObjects (Statement * stmt, unsigned int paramIndex,
			      const OCCI_STD_NAMESPACE::vector <
			      PObject * >&vect,
    ...
    void setVectorOfPObjects (Statement * stmt, unsigned int paramIndex,
			      const OCCI_STD_NAMESPACE::vector <
			      PObject * >&vect, const UString & schemaName,
    ...
    void setVectorOfOCIRefs (Statement * stmt, unsigned int paramIndex,
			     ...
			     const OCCI_STD_NAMESPACE::vector < OCIInd >
			     &vecind,
			     const OCCI_STD_NAMESPACE::string & sqltype);
    void setVectorOfOCIRefs (Statement * stmt, unsigned int paramIndex,
			     const OCCI_STD_NAMESPACE::vector < void *>&vect,
    ...
    void setVectorOfOCIRefs (Statement * stmt, unsigned int paramIndex,
			     const OCCI_STD_NAMESPACE::vector < void *>&vect,
			     const OCCI_STD_NAMESPACE::vector < OCIInd >
			     &vecind, const UString & schemaName,
			     const UString & typeName);
...
// partial function template specialization
    ...
    template < class T >
      void setVector (Statement * stmt, unsigned int index,
		      const OCCI_STD_NAMESPACE::vector < T > &vect,
		      const UString & schemaName, const UString & typeName)
    {
      OCCI_STD_NAMESPACE::vector < PObject * >vec_pobj;
      unsigned int size = vect.size ();
      vec_pobj.reserve (size);
...
*/
      ...
      for (unsigned int i = 0; i < size; i++)
	{
	  ...
	  vec_ind.push_back (vect[i].
			     isNull ()? OCI_IND_NULL : OCI_IND_NOTNULL);
	}
      ...
      for (unsigned int i = 0; i < size; i++)
	{
      ...
      setVectorOfOCIRefs (stmt, index, vec_ref, vec_ind, schemaName,
			  typeName);
    }
...
*/
    ...
    template < class T >
      void setVectorOfRefs (Statement * stmt, unsigned int index,
			    const OCCI_STD_NAMESPACE::vector < Ref < T >
			    >&vect,
			    const OCCI_STD_NAMESPACE::string & sqltype)
    {
      OCCI_STD_NAMESPACE::vector < void *>vec_ref;
