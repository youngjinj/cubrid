...
//check for version = 3.2 or 3.3
    ...
    typedef OCCI_STD_NAMESPACE::basic_string < utext,
      utext_char_traits > UString;
#else
...
/*---------------------------------------------------------------------------
  ...
  ---------------------------------------------------------------------------*/
    ...
    enum LockOptions
    { OCCI_LOCK_NONE = OCI_LOCK_NONE,
      OCCI_LOCK_X = OCI_LOCK_X,
      OCCI_LOCK_X_NOWAIT = OCI_LOCK_X_NOWAIT
    };

    enum
    { OCCI_MAX_PREFETCH_DEPTH = UB4MAXVAL };
    ...
    enum LobOpenMode
    { OCCI_LOB_READONLY = OCI_LOB_READONLY, OCCI_LOB_READWRITE =
	OCI_LOB_READWRITE, OCCI_LOB_WRITEONLY =
	OCI_LOB_WRITEONLY, OCCI_LOB_APPENDONLY =
	OCI_LOB_APPENDONLY, OCCI_LOB_FULLOVERWRITE =
	OCI_LOB_FULLOVERWRITE, OCCI_LOB_FULLREAD = OCI_LOB_FULLREAD
    };
    ...
    enum LobOptionType
    {
      ...
      OCCI_LOB_OPT_MIMETYPE = OCI_LOB_OPT_MIMETYPE,
  ...
  template < class T > class Ptr:public ConstPtr < T >
    {
...
#ifdef MEMBER_TEMPLATE
      template < class OtherType > operator        Ptr < OtherType > ();
#endif
...
/*---------------------------------------------------------------------------
  ...
  ---------------------------------------------------------------------------*/
    ...
    template < class T > void getVectorOfRefs (const AnyData & any,
					       OCCI_STD_NAMESPACE::vector <
					       Ref < T > >&vect);
    ...
    void setVector (AnyData & any,
		    ...
		    OCCI_STD_NAMESPACE::string > &vect);
    void setVector (AnyData & any,
    ...
    template < class T > void setVectorOfRefs (AnyData & any,
    ...
    void getVector (ResultSet * rs, unsigned int index,
		    OCCI_STD_NAMESPACE::vector < OCCI_STD_NAMESPACE::string >
		    &vect);
    void getVector (ResultSet * rs, unsigned int index, OCCI_STD_NAMESPACE::vector < UString > &vect);	//UTF16 support
    ...
    void getVector (Statement * rs, unsigned int index,
		    OCCI_STD_NAMESPACE::vector < OCCI_STD_NAMESPACE::string >
		    &vect);
    void getVector (Statement * rs, unsigned int index, OCCI_STD_NAMESPACE::vector < UString > &vect);	//UTF16 support
    void getVector (Statement * rs, unsigned int,
		    OCCI_STD_NAMESPACE::vector < unsigned int >&vect);
    void getVector (Statement * rs, unsigned int,
		    OCCI_STD_NAMESPACE::vector < float >&vect);
    ...
    void setVector (Statement * stmt, unsigned int paramIndex,
		    const OCCI_STD_NAMESPACE::vector < Date > &vect,
		    const OCCI_STD_NAMESPACE::string & sqltype);
    template < class T > void setVectorOfRefs (Statement * stmt,
...
/* Global method for array pins */
    ...
    void readVectorOfClobs (const Connection * conn,
			    ...
			    oraub8 * offsets, unsigned char *buffers[],
			    oraub8 * buffer_lens);
