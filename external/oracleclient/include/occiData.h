  ...
  namespace occi
  {
    ...
    private:
      ...
      friend void setVector (AnyData & any,
			     const OCCI_STD_NAMESPACE::vector < Bytes >
			     &vect);
    ...
    private:
      ...
      //Enumerations:
      enum
      { MAXDIRNAMELEN = 32, MAXFILENAMELEN = 256 };
...
// See the end of this file for implementation of LobRegion
    ...
    private:
      ...
      void setPrimary (const ConnectionImpl * connp, OCILobLocator * locator);
    ...
    public:
      ...
      void getDeduplicateRegions (OCCI_STD_NAMESPACE::vector < BlobRegion >
				  &regions);
    private:
    ...
    public:
      ...
      void getDeduplicateRegions (OCCI_STD_NAMESPACE::vector < ClobRegion >
				  &regions);
	...
	LobRegion < Clob >::setPrimary (const ConnectionImpl * connp,
      ...
      friend void writeVectorOfClobs (const Connection * conn,
				      OCCI_STD_NAMESPACE::vector < Clob >
				      &vec, oraub8 * byte_amts,
				      oraub8 * char_amts, oraub8 * offsets,
				      unsigned char *buffers[],
				      oraub8 * buffer_lens);
      friend void readVectorOfClobs (const Connection * conn,
				     OCCI_STD_NAMESPACE::vector < Clob > &vec,
				     oraub8 * byte_amts, oraub8 * char_amts,
				     oraub8 * offsets, utext * buffers[],
				     oraub8 * buffer_lens);
      friend void writeVectorOfClobs (const Connection * conn,
				      OCCI_STD_NAMESPACE::vector < Clob >
				      &vec, oraub8 * byte_amts,
    ...
    public:
      ...
      //  Format Number and return as a OCCI_STD_NAMESPACE::string
        OCCI_STD_NAMESPACE::string toText (const Environment * envp,
					   ...
					   string & fmt,
					   const OCCI_STD_NAMESPACE::
					   string & nlsParam = "") const;
      UString toText (const Environment * envp, const UString & fmt,
    ...
    private:
      ...
      friend void setVector (AnyData & any,
			     const OCCI_STD_NAMESPACE::vector < Number >
			     &vect);
      ...
      friend void getVector (Statement * stmt, unsigned int paramIndex,
			     OCCI_STD_NAMESPACE::vector < Number > &vect);
      friend void do_setVectorOfNumber (Statement * stmt,
					unsigned int paramIndex,
					const OCCI_STD_NAMESPACE::vector <
					Number > &vect, void *schemaName,
    ...
    public:
      ...
      void setDate (int year = 1, unsigned int month = 1, unsigned int day =
		    1, unsigned int hour = 0, unsigned int minute =
		    0, unsigned int seconds = 0);
      ...
      void fromBytes (const Bytes & byteStream,
        ...
        OCCI_STD_NAMESPACE::string toText (const OCCI_STD_NAMESPACE::
					   string & fmt =
					   "",
					   const OCCI_STD_NAMESPACE::
					   string & nlsParam = "") const;
    ...
    private:
      ...
      void constructHourAndMinute (sb4 & seconds, sb4 & hours,
				   sb4 & minutes) const;
      ...
      friend void getVector (Statement * stmt, unsigned int paramIndex,
			     OCCI_STD_NAMESPACE::vector < Date > &vect);
      friend void do_setVectorOfDate (Statement * stmt,
				      unsigned int paramIndex,
				      const OCCI_STD_NAMESPACE::vector <
				      Date > &vect, void *schemaName,
				      unsigned int schemaNameLen,
				      void *typeName,
				      unsigned int typeNameLen);
      friend void getVector (ResultSet * rs, unsigned int colIndex,
    ...
    public:
      ...
      Timestamp (const Environment * env, int year = 1,
		 unsigned int month = 1, unsigned int day =
		 1, unsigned int hour = 0, unsigned int min =
		 0, unsigned int sec = 0, unsigned int fs = 0, int tzhour =
		 0, int tzmin = 0);
        Timestamp (const Environment * env, int year, unsigned int month,
		   unsigned int day, unsigned int hour, unsigned int min,
		   unsigned int sec, unsigned int fs,
      ...
      void getDate (int &year, unsigned int &month, unsigned int &day) const;
        OCCI_STD_NAMESPACE::string toText (const OCCI_STD_NAMESPACE::
					   string & fmt, unsigned int fsprec,
					   const OCCI_STD_NAMESPACE::
					   string & nlsParam = "") const;
      UString toText (const UString & fmt, unsigned int fsprec,
		      const UString & nlsParam) const;
    ...
    private:
      ...
      friend void setVector (AnyData & any,
			     const OCCI_STD_NAMESPACE::vector < Timestamp >
			     &vect);
      friend Timestamp MetaData::getTimestamp (MetaData::AttrId attrid) const;
    ...
    public:
      ...
      IntervalDS (const Environment * env, int day = 0,
		  int hour = 0, int minute = 0, int second = 0, int fs = 0);
      ...
      friend bool operator> (const IntervalDS & a, const IntervalDS & b);
      friend bool operator< (const IntervalDS & a, const IntervalDS & b);
      friend bool operator >= (const IntervalDS & a, const IntervalDS & b);
      friend bool operator <= (const IntervalDS & a, const IntervalDS & b);
    ...
    private:
      ...
      void allocateDataMembers (OCIEnv * env);
      friend const IntervalDS Timestamp::subDS (const Timestamp & val) const;
      friend const Timestamp Timestamp::
	intervalAdd (const IntervalDS & val) const;
      friend const Timestamp Timestamp::
	intervalSub (const IntervalDS & val) const;
      friend class Date;
      friend void getVector (ResultSet * rs, unsigned int,
      ...
      friend void getVector (const AnyData & any,
			     OCCI_STD_NAMESPACE::vector < IntervalDS > &vect);
      friend void setVector (AnyData & any,
			     const OCCI_STD_NAMESPACE::vector < IntervalDS >
			     &vect);
    ...
    private:
      ...
      OCIInterval *getOCIInterval () const;
      void allocateDataMembers (OCIEnv * env);
      friend const IntervalYM Timestamp::subYM (const Timestamp & val) const;
      friend const Timestamp Timestamp::
	intervalAdd (const IntervalYM & val) const;
      friend const Timestamp Timestamp::
	intervalSub (const IntervalYM & val) const;
      ...
      friend void getVector (const AnyData & any,
			     OCCI_STD_NAMESPACE::vector < IntervalYM > &vect);
      friend void setVector (AnyData & any,
			     const OCCI_STD_NAMESPACE::vector < IntervalYM >
			     &vect);
...
/*
   ...
   NOTES
*/
    template < typename lobType > LobRegion < lobType >::LobRegion ()
    {
      _primary = (lobType *) 0;
      _primaryOffset = 0;
      _offset = 0;
...
*/
    ...
    template < typename lobType > oraub8 LobRegion < lobType >::getOffset ()
    {
      return _offset;
    }

    template < typename lobType > oraub8 LobRegion < lobType >::getLength ()
    {
      return _length;
    }
