...
namespace oracle
{
  namespace occi
  {
    ...
    public:
      enum LockOption
      { OCCI_LOCK_WAIT, OCCI_LOCK_NOWAIT };
      enum UnpinOption
      { OCCI_PINCOUNT_DECR, OCCI_PINCOUNT_RESET };
      ...
      void *operator        new (size_t size, const Connection * sess,
				 ...
				 const UString & schTabName,
				 const UString & schTypName);
    ...
    private:
      ...
      ub2 flags_;
      enum
      { NULL_INFO = 0x0001, GARBAGE_COLLECTED = 0x0002,
    ...
    public:
      ...
      AnyData (void *any);
        ...
        AnyData (const Connection * sessp, OCIAnyData * any, bool freeImg =
		 true);
    ...
    public:
      ...
      void setPrefetch (const UString & schName,
			const UString & typeName, unsigned int depth);
    ...
    template < class T > Ref < T >::Ref (const T * obj)
    {
      rimplPtr = new RefImpl ((PObject *) obj);
    }

    template < class T > Ref < T >::Ref (const RefAny & refAny)
    {
      rimplPtr = new RefImpl (refAny);
    }

    template < class T > Ref < T >::Ref (const Ref < T > &src)
    {
    ...
    template < class T > Ref < T > &Ref < T >::operator= (const T * obj)
    {
    ...
    template < class T > Ref < T > &Ref < T >::operator= (const RefAny & src)
    {
    ...
    template < class T > const T *Ref < T >::operator-> () const
    {
      return ((const T *) rimplPtr->pin ());
    }

    template < class T > const T *Ref < T >::ptr () const
    {
      return ((const T *) rimplPtr->pin ());
    }
    ...
    template < class T > void Ref < T >::markDelete ()
    {
      rimplPtr->markDelete ();
    }

    template < class T > void Ref < T >::unmarkDelete ()
    {
      rimplPtr->unmarkDelete ();
    }

    template < class T > void Ref < T >::setNull ()
    {
      rimplPtr->setNull ();
    }

    template < class T > bool Ref < T >::isNull ()const
    {
    ...
    template < class T > bool Ref < T >::isClear ()const
    {
    ...
    template < class T >
      void Ref <
      T >::setPrefetch (const OCCI_STD_NAMESPACE::string & typeName,
			unsigned int depth)
    {
    ...
    template < class T >
      void Ref <
      T >::setPrefetch (const OCCI_STD_NAMESPACE::string & schemaName,
			const OCCI_STD_NAMESPACE::string & typeName,
			unsigned int depth)
    {
    ...
    template < class T > void Ref < T >::setPrefetch (unsigned int depth)
    {
      rimplPtr->setPrefetch (depth);
    }

    template < class T > void Ref < T >::setLock (LockOptions lckOption)
    {
      rimplPtr->setLock (lckOption);
    }

    template < class T > OCIRef * Ref < T >::getRef ()const
    {
      return (rimplPtr->getRef ());
    }

    template < class T > const Connection *Ref < T >::getConnection () const
    {
      return (rimplPtr->getConnection ());
    }

    template < class T > Ref < T >::operator        RefAny () const
    {
      if (isNull ())
	return RefAny ();
    ...
    template < class T > bool Ref < T >::operator == (const Ref < T > &ref) const
    {
    ...
    template < class T > bool Ref < T >::operator == (const RefAny & refAnyR) const
    {
    ...
    template < class T > void Ref < T >::destroy ()
    {
      rimplPtr->destroy ();
    }

    template < class T > OCIComplexObject * Ref < T >::getCor ()const
    {
      return (rimplPtr->getCor ());
    }

    template < class T > void Ref < T >::setPinnedObject (PObject * objPtr)
    {
